...
// export module m { export const x: number }
// export module m { export namespace nn { export const x: number } }
export module m { export module mm { export const x: number } }
...
// export type Mnnx = typeof m.nn.x;
export type Mmmx = typeof m.mm.x;
`;
